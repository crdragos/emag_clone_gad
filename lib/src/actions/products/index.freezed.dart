...
abstract class $SetSelectedCategoryCopyWith<$Res> {
  factory $SetSelectedCategoryCopyWith(SetSelectedCategory value, $Res Function(SetSelectedCategory) then) =
      _$SetSelectedCategoryCopyWithImpl<$Res>;
  $Res call({String category});
}

/// @nodoc
class _$SetSelectedCategoryCopyWithImpl<$Res> implements $SetSelectedCategoryCopyWith<$Res> {
...
/// @nodoc
abstract class $SetSelectedCategory$CopyWith<$Res> implements $SetSelectedCategoryCopyWith<$Res> {
  factory $SetSelectedCategory$CopyWith(SetSelectedCategory$ value, $Res Function(SetSelectedCategory$) then) =
...
/// @nodoc
class _$SetSelectedCategory$CopyWithImpl<$Res> extends _$SetSelectedCategoryCopyWithImpl<$Res>
    implements $SetSelectedCategory$CopyWith<$Res> {
  _$SetSelectedCategory$CopyWithImpl(SetSelectedCategory$ _value, $Res Function(SetSelectedCategory$) _then)
...
class _$SetSelectedCategory$ implements SetSelectedCategory$ {
  ...
  $SetSelectedCategory$CopyWith<SetSelectedCategory$> get copyWith =>
      _$SetSelectedCategory$CopyWithImpl<SetSelectedCategory$>(this, _$identity);
}
...
abstract class $SetSelectedProductIdCopyWith<$Res> {
  factory $SetSelectedProductIdCopyWith(SetSelectedProductId value, $Res Function(SetSelectedProductId) then) =
      _$SetSelectedProductIdCopyWithImpl<$Res>;
  $Res call({String productId});
}

/// @nodoc
class _$SetSelectedProductIdCopyWithImpl<$Res> implements $SetSelectedProductIdCopyWith<$Res> {
...
/// @nodoc
abstract class $SetSelectedProductId$CopyWith<$Res> implements $SetSelectedProductIdCopyWith<$Res> {
  factory $SetSelectedProductId$CopyWith(SetSelectedProductId$ value, $Res Function(SetSelectedProductId$) then) =
...
/// @nodoc
class _$SetSelectedProductId$CopyWithImpl<$Res> extends _$SetSelectedProductIdCopyWithImpl<$Res>
    implements $SetSelectedProductId$CopyWith<$Res> {
  _$SetSelectedProductId$CopyWithImpl(SetSelectedProductId$ _value, $Res Function(SetSelectedProductId$) _then)
...
class _$SetSelectedProductId$ implements SetSelectedProductId$ {
  ...
  @override
  int get hashCode => runtimeType.hashCode ^ const DeepCollectionEquality().hash(productId);

  @override
  $SetSelectedProductId$CopyWith<SetSelectedProductId$> get copyWith =>
      _$SetSelectedProductId$CopyWithImpl<SetSelectedProductId$>(this, _$identity);
}

abstract class SetSelectedProductId$ implements SetSelectedProductId {
  const factory SetSelectedProductId$(String productId) = _$SetSelectedProductId$;
