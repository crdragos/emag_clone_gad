...
final BuiltSet<ProductState> _$values = new BuiltSet<ProductState>(const <ProductState>[
  _$inStock,
  _$lastItem,
  _$outOfStock,
]);
...
class _$ProductsStateSerializer implements StructuredSerializer<ProductsState> {
  ...
  Iterable<Object> serialize(Serializers serializers, ProductsState object,
    ...
    final result = <Object>[
      'products',
      serializers.serialize(object.products, specifiedType: const FullType(BuiltList, const [const FullType(Product)])),
      'searchedProducts',
      serializers.serialize(object.searchedProducts,
          specifiedType: const FullType(BuiltList, const [const FullType(Product)])),
    ];
    if (object.selectedCategory != null) {
      result
        ..add('selectedCategory')
        ..add(serializers.serialize(object.selectedCategory, specifiedType: const FullType(String)));
    }
    if (object.selectedProductId != null) {
      result
        ..add('selectedProductId')
        ..add(serializers.serialize(object.selectedProductId, specifiedType: const FullType(String)));
    }
    return result;
  }

  @override
  ProductsState deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
      ...
      switch (key) {
        case 'products':
          result.products.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [const FullType(Product)])) as BuiltList<Object>);
          break;
        case 'searchedProducts':
          result.searchedProducts.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [const FullType(Product)])) as BuiltList<Object>);
          break;
        case 'selectedCategory':
          result.selectedCategory = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case 'selectedProductId':
          result.selectedProductId = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
      }
    }
...
class _$ProductSerializer implements StructuredSerializer<Product> {
  ...
  Iterable<Object> serialize(Serializers serializers, Product object, {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      ...
      'price',
      serializers.serialize(object.price, specifiedType: const FullType(double)),
      'description',
      ...
      'review',
      serializers.serialize(object.review, specifiedType: const FullType(double)),
      'productState',
      serializers.serialize(object.productState, specifiedType: const FullType(ProductState)),
      'searchIndex',
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'images':
          ...
          break;
        case 'review':
          result.review = serializers.deserialize(value, specifiedType: const FullType(double)) as double;
          break;
        case 'productState':
          result.productState =
              serializers.deserialize(value, specifiedType: const FullType(ProductState)) as ProductState;
          break;
        case 'searchIndex':
...
class _$ProductStateSerializer implements PrimitiveSerializer<ProductState> {
  ...
  @override
  Object serialize(Serializers serializers, ProductState object, {FullType specifiedType = FullType.unspecified}) =>
      object.name;
...
class _$ProductsState extends ProductsState {
  ...
  @override
  final BuiltList<Product> searchedProducts;
  @override
  ...
  _$ProductsState._({this.products, this.searchedProducts, this.selectedCategory, this.selectedProductId}) : super._() {
    if (products == null) {
      throw new BuiltValueNullFieldError('ProductsState', 'products');
    }
    if (searchedProducts == null) {
      throw new BuiltValueNullFieldError('ProductsState', 'searchedProducts');
    }
  }

  @override
  ProductsState rebuild(void Function(ProductsStateBuilder) updates) => (toBuilder()..update(updates)).build();
  ...
  bool operator ==(Object other) {
    ...
    return other is ProductsState &&
        ...
        searchedProducts == other.searchedProducts &&
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc($jc(0, products.hashCode), searchedProducts.hashCode), selectedCategory.hashCode),
  ...
  String toString() {
    return (newBuiltValueToStringHelper('ProductsState')
          ...
          ..add('searchedProducts', searchedProducts)
...
class ProductsStateBuilder implements Builder<ProductsState, ProductsStateBuilder> {
  _$ProductsState _$v;
  ...
  ListBuilder<Product> _searchedProducts;
  ListBuilder<Product> get searchedProducts => _$this._searchedProducts ??= new ListBuilder<Product>();
  set searchedProducts(ListBuilder<Product> searchedProducts) => _$this._searchedProducts = searchedProducts;

  String _selectedCategory;
  String get selectedCategory => _$this._selectedCategory;
  set selectedCategory(String selectedCategory) => _$this._selectedCategory = selectedCategory;

  String _selectedProductId;
  String get selectedProductId => _$this._selectedProductId;
  set selectedProductId(String selectedProductId) => _$this._selectedProductId = selectedProductId;
  ...
  ProductsStateBuilder get _$this {
    if (_$v != null) {
      ...
      _searchedProducts = _$v.searchedProducts?.toBuilder();
    ...
    try {
      _$result = _$v ??
          new _$ProductsState._(
              ...
              searchedProducts: searchedProducts.build(),
      ...
      try {
        ...
        products.build();
        _$failedField = 'searchedProducts';
        searchedProducts.build();
      } catch (e) {
        throw new BuiltValueNestedFieldError('ProductsState', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc(
                    $jc($jc($jc($jc($jc(0, id.hashCode), title.hashCode), price.hashCode), description.hashCode),
                        category.hashCode),
                    images.hashCode),
                review.hashCode),
...
class ProductBuilder implements Builder<Product, ProductBuilder> {
  ...
  set productState(ProductState productState) => _$this._productState = productState;
